...
VUTEST     DISPLAY 'MORE-DATA-SW ' MORE-DATA-SW.
           IF NO-MORE-DATA
...
VUTEST     DISPLAY '100-MAINLINE...'.
      ...
      ******** Specific requirements for certain frocedures
           ...
           IF  CHEMO-THERAPY OR RADIATION-THERAPY OR SURGERY
              MOVE +0 TO STR-LTH
      *       CALL 'LENPGM' USING TREATMENT-COMMENTS, STR-LTH
              IF STR-LTH < 25
...
VUTEST     DISPLAY '800-OPEN-FILES...'.
       ...
       900-READ-TRMTDATA.
VUTEST     DISPLAY '900-READ-TRMTDATA...'.
...
VUTEST     DISPLAY '900.1 RECORDS-READ = ' RECORDS-READ.
       900-EXIT.
           EXIT.
