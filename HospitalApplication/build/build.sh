...
##  sourceDir) path.  If omitted then HospitalApplication/build/files.txt is built.
## 
##  **NOTE - Assumes HospitalApplication/build/build.properties has been configured with 
##           default properties.  Default properties can be overridden using command options 
##           described in HospitalApplication/build/build.groovy
##
##  Examples:
##  build.sh 
##  build.sh HospitalApplication/cobol/epsnbrvl.cbl
