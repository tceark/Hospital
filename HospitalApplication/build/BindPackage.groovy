...
/**
* This script builds a DB2 application package for SQL programs in the HospitalApplication sample.  It is 
* called by the CobolCompile.groovy script.  It requires that the properties in HospitalApplication/build/bind.properties 
